...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/blogs/showFormCreate","/blogs/create","/blogs/edit"
                ,"/admin","/categories/list","/blogs/delete",
                "/categories/showFormCreateCategory").access("hasRole('ROLE_ADMIN')");
