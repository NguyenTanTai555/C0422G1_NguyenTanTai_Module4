...
import com.codegym.case_study.dto.contract.ContractDto;
...
public class ContractController {
    ...
    public String createContractDetail(@ModelAttribute @Valid ContractDetailDto contractDetailDto,
        ...
        rd.addFlashAttribute("msg", "Add new Attach Facility successfully");
        return "redirect:/contract/list";
    }
    ...
    public String createContract(@ModelAttribute @Valid ContractDto contractDto,
        ...
        rd.addFlashAttribute("msg", "Add new contract successfully");
        return "redirect:/contract/list";
    }
